      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="../AdminDesign/index.php">Dashboard</a></li>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              <a href="../AdminDesign/index.php" class="list-group-item active main-color-bg">
              ...
              <a href="../AdminDesign/users.php" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Users <span class="badge"><?php echo $usercountid;?></span></a>
                 <a data-toggle="modal" href="#populationmodal" class="list-group-item"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span> Population <span class="badge"><?php echo $getpopulation; ?></span></a>
              ...
              <div class="panel-body">
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-user" aria-hidden="true"></span> <?php echo $usercountid;?></h2>
                    <h4>Users</h4>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> <?php echo $complaintcountid; ?></h2>
                    <h4>Complaints</h4>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> <?php echo $suggestioncountid; ?></h2>
                    <h4>Suggestions</h4>
                  </div>
                </div>
...
<div class="modal fade" id="populationmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-body">
                <div class="form-group" >
                    <label for="update_first_name">Population</label>
                    <input type="text" id="population" placeholder="Population" class="form-control"/>
                </div>
 
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary" onclick="updatepopulation()"  >Save Changes</button>
            </div>
        </div>
    </div>
</div>
